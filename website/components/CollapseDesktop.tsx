...
import { IconHome, IconMusic, IconSearch, IconUser, IconUsersGroup } from "@tabler/icons-react";
  ...
  return (
    ...
    >
      ...
      <AppShell.Navbar p="md">
        ...
        {session && <NavLink href={"/translate"} label="Translate" leftSection={<IconUsersGroup size={14} stroke={1.5} />} />}
